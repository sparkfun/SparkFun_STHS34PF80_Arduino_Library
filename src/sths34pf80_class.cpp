...
int32_t STHS34PF80::getTmosSensitivity(uint16_t *sense)
{
...
int32_t STHS34PF80::setTmosSensitivity(uint16_t *val)
{
    uint16_t res1 = 2048;
    uint16_t res2 = 16;
...
int32_t STHS34PF80::getTPresenceRawValue(int16_t *val)
{
...
int32_t STHS34PF80::getTMotionRawValue(int16_t *val)
{
